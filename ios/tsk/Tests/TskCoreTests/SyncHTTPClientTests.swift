...
@Test func syncHTTPBlobClientUsesLinuxBlobWireProtocol() throws {
    ...
    #expect(pull.blobs.count == 2)
    #expect(pull.blobs[0].blob?.ciphertext == [1, 2, 3])
    #expect(pull.blobs[0].blob?.nonce == [4, 5, 6])
    #expect(pull.blobs[0].deleted == false)
    #expect(pull.blobs[1].taskId == "00000000-0000-0000-0000-000000000003")
    #expect(pull.blobs[1].blob == nil)
    #expect(pull.blobs[1].deleted == true)
