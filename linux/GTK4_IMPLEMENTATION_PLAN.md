...
- [x] User-defined lists can be renamed from the selected list page header with Enter or a confirm button, with delete moved into an out-of-the-way `⋯` page menu.
